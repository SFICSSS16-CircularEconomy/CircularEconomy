...
\date[February 17th 2020]{Workshop on Geo-industrial clusters\\
February 17th 2020
}
...
\sframe{Unsustainable use of resources}{
...
\textbf{Systems perspective} necessary to understand and optimize these processes \cite{chertow2012organizing}
...
$\rightarrow$ Data-driven approach in link with interactive application.

$\rightarrow$ Refinement of economic processes.

$\rightarrow$ Comparison of multiple possible processes and levels of policies.
